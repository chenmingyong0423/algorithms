...
func TestDoublyLinkedList_Prepend(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			list:             NewDoublyLinkedList[int](2),
			elements:         []int{1},
			wantListElements: []int{1, 2},
		},
		{
		...
		},
		{
			...
			list:             NewDoublyLinkedList[int](4, 5, 6),
			elements:         []int{1, 2, 3},
...
func TestDoublyLinkedList_Insert(t *testing.T) {
	testCases := []struct {
		...
		{
			name:     "index is less than zero",
			list:     NewDoublyLinkedList[int](1, 2, 5),
			index:    -1,
			elements: []int{3, 4},
			wantBool: false,
		},
		...
		},
		{
			...
			list:             NewDoublyLinkedList[int](2, 3),
			index:            0,
			elements:         []int{1},
			wantBool:         true,
			wantListElements: []int{1, 2, 3},
		},
		{
			...
			list:             NewDoublyLinkedList[int](3, 4),
			index:            0,
			elements:         []int{1, 2},
			wantBool:         true,
		...
		},
		{
			...
			list:             NewDoublyLinkedList[int](1, 2, 4, 5),
			index:            2,
			elements:         []int{3},
			wantBool:         true,
			wantListElements: []int{1, 2, 3, 4, 5},
		},
		{
			...
			list:             NewDoublyLinkedList[int](1, 2, 5, 6),
			index:            2,
			elements:         []int{3, 4},
			wantBool:         true,
			wantListElements: []int{1, 2, 3, 4, 5, 6},
...
func TestDoublyLinkedList_Remove(t *testing.T) {
	testCases := []struct {
		...
		{
			name:      "index is greater than zero and less than size of list",
			list:      NewDoublyLinkedList[int](1, 2, 3, 4, 5),
			index:     2,
			wantValue: 3,
			wantBool:  true,
		},
